...
function execSearch() {
     ...
     */
    // 검색시 #search-result-box의 내용을 없애준다.
...
function addProductItem(product) {
    ...
    return `<div class="product-card">
            ...
            <div class="card-body">
                ...
                <div> 
                <span class="${product.lprice <= product.myprice?'isgood':'none'}" onclick="window.location.href='${product.link}'">최저가</span>
                <span class="delete-itemDto-right" alt="" onclick='deleteProduct(${JSON.stringify(product)})'>삭제</span>
                </div>
            </div>
        </div>`;
}
